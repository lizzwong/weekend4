...
VALUES ('/images/nationalization.png', 'Citizenship', 'While my brothers and I were born in the United States, my parents did not become citizens until after I was born. This is the day of their ceremony, and one of the most important days for us as a family.', 0),
('/images/napping.jpg', 'Like Father like Daughter', 'I''m often told I resemble my father in many ways, among them an affection for potato chips, opera, and hyperactive tendencies. He also gave me his perpetual quest for knowledge, his wanderlust, and what little extroversion I have.', 0),
...
('/images/hipsters.jpg', 'Under the Sea (of Hipsters)','My best girl: Kate. We met under the judgiest of circumstances, but a friendship emerged that was, is, unshakable. Forged with movie nights, wine, cheese, and tiramisu, she is the best person to couch with.', 0),
